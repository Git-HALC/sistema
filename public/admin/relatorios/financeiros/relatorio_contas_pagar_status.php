...
use App\Modules\Relatorios\Reports\RelatorioCpStatus;
...
$selfUrl    = tenantUrl('admin/relatorios/financeiros/relatorio_contas_pagar_status.php');
...
$relatorio = new RelatorioCpStatus($db);
...
<div class="container-fluid">
    ...
    .filter-section{background:var(--bg-secondary);padding:1.5rem;border-radius:10px;margin-bottom:2rem;border-left:4px solid #dc3545;}
    ...
    .custom-table tbody tr:hover{background:rgba(220,53,69,0.1);}
    </style>

    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0"><i class="fas fa-file-invoice me-2"></i>Contas a Pagar por Status</h1>
        <div class="d-flex gap-2">
            <a href="<?php echo htmlspecialchars(tenantUrl('admin/financeiro/contas-pagar.php')); ?>" class="btn btn-outline-secondary">
                <i class="fas fa-arrow-circle-up me-1"></i>Contas a Pagar
            </a>
    ...
    <form method="GET" class="filter-section">
        <div class="row g-3">
            ...
            <div class="col-md-3 d-flex align-items-end gap-2">
                <button type="submit" class="btn btn-danger flex-fill"><i class="fas fa-search me-1"></i>Filtrar</button>
    ...
    <div class="resumo-card">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="resumo-item"><span>Valor Pago</span><span class="resumo-value positive">R$ <?= number_format((float)($totais['valor_pago'] ?? 0), 2, ',', '.') ?></span></div>
            </div>
            <div class="col-md-3">
                            ...
                            <?php foreach ($contas as $c): ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?php
                                        $badgeMap = ['Pago' => 'success', 'Pendente' => 'warning', 'Vencido' => 'danger', 'Parcialmente Pago' => 'info', 'Cancelado' => 'secondary'];
